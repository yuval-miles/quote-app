...
import quoteContentMap from "../MapFuncs/QuoteContentMap";

const QCContainer =  connect(quoteContentMap.mapStateToProps,null)(QuoteContent);

class QuotePageComp extends React.Component{
